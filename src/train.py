from model import CoinClassifier # from model_3 import CoinClassifier
...
feature_models = ['efficientnet', 'resnet50', 'regnet'] 
...
for feature_model in feature_models:
    for stage in stages:
        for features_number in features_numbers:
            test_name = f'model_3/{feature_model}/{stage}/{features_number}'
